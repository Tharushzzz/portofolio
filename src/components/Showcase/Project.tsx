...
const Project = ({ title, description, technologies, image, live, github }: ProjectProps) => {
  return (
        ...
        <div className="flex flex-col justify-between gap-6 rounded-3xl border border-white/10 bg-linear-to-br from-cyan-500/15 via-white/5 to-transparent p-6">
            <div>
                ...
                <div className="flex gap-6">
                    <a href={live} className="inline-flex items-center gap-2 text-sm font-semibold text-cyan-100 transition duration-300 hover:-translate-y-0.5 hover:text-white"> View Project <span className="text-cyan-400">→</span></a>
                    <a href={github} className="inline-flex items-center gap-2 text-sm font-semibold text-cyan-100 transition duration-300 hover:-translate-y-0.5 hover:text-white"> GitHub <span className="text-cyan-400">→</span></a>
                </div>
